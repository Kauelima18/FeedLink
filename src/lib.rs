// src/lib.rs
/*
 * Core library for FeedLinkChain
 */
...
#[derive(Debug)]
pub struct FeedLinkChainProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FeedLinkChainProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FeedLinkChain processing");
    
    let mut processor = FeedLinkChainProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FeedLinkChainProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FeedLinkChainProcessor::new(false);
